			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="{{ route('registrasi') }}" method="POST">
					...
					<div class="container">
                        ...
                        <div class="wrap-input100 validate-input m-b-26" data-validate="Nama Wajid Diisi">
                            <span class="label-input100">Nama</span>
                            <input class="input100" type="text" value="" name="name" placeholder="Masukkan nama">
                            <span class="focus-input100"></span>
                        </div>

                        <div class="wrap-input100 validate-input m-b-26" data-validate="Email Wajid Diisi">
							<span class="label-input100">Email</span>
							<input class="input100" type="email" value="" name="email" placeholder="Masukan email">
							<span class="focus-input100"></span>
						</div>

						<div class="wrap-input100 validate-input m-b-18" data-validate="Password Wajib Diisi">
							<span class="label-input100">Password</span>
							<input class="input100" type="text" name="password" placeholder="Masukan password">
							<span class="focus-input100"></span>
						</div>
